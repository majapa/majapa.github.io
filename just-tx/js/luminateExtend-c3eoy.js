        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-loading').remove();
           $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' + 
                                     '<p><img style=\"font-size: 10pt;\" src="../images/content/pagebuilder/txr-thanks-717.png" border="0" alt="Texas Rising Thank You" width=\"717\" height=\"364\" /></p><p>Your generous donation of $' +
data.donationResponse.donation.amount.decimal +
' means the world to us. Contributions to the Texas Freedom Network Education Fund are tax-deductible to the full extent allowed by law.</p><p><a href=\"PageServer?pagename=homepage\">Return to Home Page</a></p>' +
'</div>');
        }
      }
    };
