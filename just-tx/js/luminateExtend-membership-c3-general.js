      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you!</h1><p>Thank you for your gift of $' + data.donationResponse.donation.amount.decimal + ' to the Texas Freedom Network Education Fund. We are deeply grateful for your generosity and support of our vital work.</p><p>You will receive an e-mail shortly to confirm your contribution, please&nbsp;save it for your records. The Texas Freedom Network Education Fund is a 501(c)(3) non-profit corporation. No goods or services were exchanged for your gift, and your contribution is tax-deductible to the fullest extent under law. Thank you again for your&nbsp;support, it means the world to us!</p><p><br><a href=\"PageServer?pagename=homepage\">Return to Home Page</a></p>' +
                                     '</div>');
        }
      }
    };
