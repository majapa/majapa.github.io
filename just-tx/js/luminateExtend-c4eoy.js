...
' means the world to us. Due to TFN\'s hard-hitting political activism, contributions are not tax-deductible.</p><p><a href=\"PageServer?pagename=homepage\">Return to Home Page</a></p>' +
'</div>');
        }
      }
    };
