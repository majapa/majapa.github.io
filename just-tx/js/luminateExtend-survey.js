      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you!</h1><p>Thank you for your membership gift of $' + data.donationResponse.donation.amount.decimal + ' to the Texas Freedom Network. We are deeply grateful for your generosity and support of our vital work.</p><p>There is power in numbers, and we\'re thankful you\'re part of our network of more than 85,000 supporters. But there are more of us out there, so spread the word! Click below to share on Facebook and Twitter.<br><br><a href=\"http://www.facebook.com/sharer/sharer.php?u=https://secure2.convio.net/txfree/site/SPageNavigator/DM1014web_responsive.html\" target=\"_blank\"><img src=\"../images/content/pagebuilder/facebookshare.png?t=1399573415922\" alt=\"Share on Facebook\" /></a>&nbsp; &nbsp; &nbsp;<a href=\"https://twitter.com/home?status=I%27m%20a%20member%20of%20the%20Texas%20Freedom%20Network%20%E2%80%93%20defender%20of%20religious%20freedom,%20civil%20liberties%20%26%20public%20schools.%20You%20in?%20tfn.org/membershipdrive\" target=\"_blank\"><img src=\"../images/content/pagebuilder/twittershare.png?t=1399573462930\" alt=\"Share on Twitter\" /></a></p><p>You will receive an e-mail shortly to confirm your contribution, please&nbsp;save it for your records. Due to our hard-hitting political activism, contributions are not tax-deductible. Thank you again for your&nbsp;support, it means the world to us!</p><p><br><a href=\"PageServer?pagename=homepage\">Return to Home Page</a></p>' +
                                     '</div>');
        }
      }
    };
      ...
      success: function(data) {
        ...
        if(data.submitSurveyResponse.success == 'false') {
          ...
          $('.survey-form').before('<div class="alert alert-success">' +
                                       '<strong>Thank you!</strong> Your name has been added to this request to publishers.' +
                                     '</div>' +
                                     '<div class="well">' +
                                       '<p>Ask your networks to join you to put the pressure on textbook publishers: <br ><a href=\'https://www.facebook.com/sharer/sharer.php?u=http://www.tfn.org/site/PageNavigator/textbook_religious_influence.html\'>Facebook</a> | <a href=\'https://twitter.com/home?status=I%20just%20told%20publishers%20Moses%20doesn&#39;t%20belong%20in%20government%20textbooks.%20Help%20keep%20textbooks%20balanced:%20tfn.org/moses%20@tfn\'>Twitter</a>.</p><p>Can you help support this campaign? <a href=\'http://www.tfn.org/site/Donation2?4020.donation=form1&df_id=4020\'>Click here to make a donation</a>.' +
                                     '</div>');
        }
      }
    };
