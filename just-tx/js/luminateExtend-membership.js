      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you!</h1><p>Thank you for your membership gift of $' + data.donationResponse.donation.amount.decimal + ' to the Texas Freedom Network. We are deeply grateful for your generosity and support of our vital work.</p><p>There is power in numbers, and we\'re thankful you\'re part of our network of more than 100,000 supporters. </p><p>You will receive an e-mail shortly to confirm your contribution, please&nbsp;save it for your records. Due to our hard-hitting political activism, contributions are not tax-deductible. Thank you again for your&nbsp;support, it means the world to us!</p><p><br><a href=\"http://www.tfn.org\">Return to Home Page</a></p>' +
                                     '</div>');
        }
      }
    };
