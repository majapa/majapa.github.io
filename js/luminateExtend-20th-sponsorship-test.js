  ...
  $(function() {
    ...
    if($('.donation-form').length > 0) {
      $('input[name="level_id"]').click(function() {
        ...
        else if($(this).is('#other-amount')) {
          $('#other-amount').removeAttr('disabled');
          $('#level-other').Check = true;
          $('#other-amount').attr('name', 'other_amount');
          $('#other-amount').focus();
        }
        else {
      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                       'Your sponsorship has been processed!' +
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you! </h1><p>Thank you so much for your generous support of the Texas Freedom Network\'s\&nbsp;20th anniversary reception. You will receive an email shortly with more details about the special event.\&nbsp;</p><p><em>Due to our hard-hitting political activism, contributions are not tax-deductible.</em></p><p>Your support means the world to us. Please consider taking some additional steps to help TFN.</p><ul><li>Get involved in our advocacy work at the <a href=\"PageServer?pagename=involved_join_activist_network\">Texas Legislature</a>.</li><li>Learn more about our youth outreach program <a href=\"http://www.txrising.org\" target=\"_blank\">Texas Rising</a>.\&nbsp;</li><li>Check out\&nbsp;our popular\&nbsp;blog\&nbsp;<a href=\"http://www.tfninsider.org\" target=\"_blank\">TFN Insider</a>.</li></ul><p>Thank you again for your support! If you need additional information please contact Rachel Glast at 512-322-0545 or <a href=\"mailto:rachel@tfn.org\">rachel@tfn.org</a>.\&nbsp;</p>' +
                                     '</div>');
        }
      }
    };
