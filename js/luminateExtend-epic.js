      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you!</h1><p>Thank you for your membership gift of $' + data.donationResponse.donation.amount.decimal + ' to the Texas Freedom Network. We are deeply grateful for your generosity and support of our vital work.</p>' +
                                     '</div>');
        }
      }
    };
