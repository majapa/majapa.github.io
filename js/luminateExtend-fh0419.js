      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you!</h1><p>Thank you so much for your generous support of the Texas Freedom Network\'s 21st annual members\' reception in Houston on Tuesday, April 19. You will receive an email shortly with more details about the special event.</p><p><em>Due to our hard-hitting political activism, contributions are not tax-deductible.</em></p><p>Your support means the world to us. Please consider taking some additional steps to help TFN.</p><ul><li>Get involved in our advocacy work at the <a href=\"http://tfn.org/issue/textbook-censorship/\" target=\"_blank\">State Board of Education</a>.</li><li>Learn more about our youth outreach program <a href=\"http://www.txrising.org\" target=\"_blank\">Texas Rising</a>.</li><li>Check out our popular blog <a href=\"http://www.tfninsider.org\" target=\"_blank\">TFN Insider</a>.</li></ul><p>Thank you again for your support! If you need additional information please contact Shana Creeger at 512-322-0545 or <a href=\"mailto:shana@tfn.org\" target=\"_blank\">shana@tfn.org</a>.</p><p>&nbsp;</p><p><a href=\"http://www.tfn.org\">Return to Home Page</a></p>' +
                                     '</div>');
          $('.donation-form').hide();
        }
      }
