      ...
      success: function(data) {
        ...
        if(data.donationResponse.errors) {
          ...
          $('.donation-form').before('<div class="alert alert-success">' +
                                     ...
                                     '</div>' +
                                     '<div class="well">' +
                                       '<h1>Thank you!</h1><p>Thank you for your gift in honor of Stephanie Chiarello and Cole Noppenberg. Your contribution enables the Texas Freedom Network Education Fund to protect religious freedom, defend civil liberties and strengthen public schools in Texas.</p><p><em>The Texas Freedom Network Education Fund is a 501(c)(3) non-profit organization. No goods or services were exchanged for your gift, and your contribution is tax deductible to the full extent of the law. </em></p><p>You will receive an email shortly to confirm your contribution; please save it for your records.</p><p><a href=\"http://www.tfn.org\">Return to Home Page</a></p>' +
                                     '</div>');
          $('.donation-form').hide();
        }
      }
