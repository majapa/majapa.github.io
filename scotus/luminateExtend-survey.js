(function($) {
  ...
  luminateExtend({
    apiKey: 'f74kbb8kl',
    path: {
      nonsecure: 'http://txfree.convio.net/site/',
      ...
      success: function(data) {
        ...
        if(data.submitSurveyResponse.success == 'false') {
          ...
          $('.survey-form').before('<div class="alert alert-success">' +
                                       '<strong>Thank you!</strong> Your name has been added calling for the rejection of the flawed Mexican American Heritage textbook.' +
                                     '</div>');
        }
      }
    };
